...
move_uploaded_file($_FILES['image']['tmp_name'],$location);
    ...
    $sentencia=$conn->prepare("INSERT INTO tb_almacen 
     (codigo, nombre, descripcion, stock, stock_minimo, stock_maximo, precio_compra, precio_venta, fecha_ingreso, imagen, id_usuario, id_categoria, fyh_creacion) VALUES
